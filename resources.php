        ...
        <div class="row" id="primary">
            <div id="content" class="col-sm-12">
                <section class="main-content">
                    <p class="lead">
                        Welcome to the Bootstrap to Wordpress resources page!
                    </p>
                    <p>

                      Copy to clipboard
                      
                      Viking skald berserker ikea sailing skald lack the table, viking raiding the kracken bjorn the chair. 
                      Horns scandinavia terror loot bjorn the chair raiding bjorn the chair. Swords axes swords the kracken sea loot, boats Beowulf sea loot longship scandinavia.
                      Lack the table raiding Beowulf Beowulf tall blond women berserker loot Beowulf. 
                      Ikea skald Leif Erikson sea bjorn the chair Beowulf ikea scandinavia Leif Erikson. 
                      Terror Leif Erikson sailing longship terror longship longship axes, horns bork bork bork scandinavia Leif Erikson horns.</p>
                    ...
                    <div class="resource-row clearfix">
                        <div class="resource">
                            ...
                            <p>
                        Viking skald berserker ikea sailing skald lack the table, viking raiding the kracken bjorn the chair. 
                        Horns scandinavia terror loot bjorn the chair raiding bjorn the chair. Swords axes swords the kracken sea loot, boats 
                        Beowulf sea loot longship scandinavia.
                            </p>
